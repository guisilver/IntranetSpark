...
@Entity
public class intra_cndlteio2 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4517975084344804363L;
	@Id
	@GeneratedValue
	private int id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		intra_cndlteio2 other = (intra_cndlteio2) obj;
		if (bloco == null) {
			if (other.bloco != null)
				return false;
