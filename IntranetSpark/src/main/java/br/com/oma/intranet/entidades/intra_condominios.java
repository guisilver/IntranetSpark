...
@Entity
public class intra_condominios implements Comparable<intra_condominios>, Serializable {


	/**
	 * 
	 */
	private static final long serialVersionUID = 260567003086984606L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		intra_condominios other = (intra_condominios) obj;
		if (bairro == null) {
	...
	@Override
	public int compareTo(intra_condominios o) {
