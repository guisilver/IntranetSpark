...
@Entity
@Table(name="cndpagar_followup", schema="omaonline.dbo")
public class cndpagar_followup implements Serializable{
	...
	private String ip;
	@Column(name = "obs", columnDefinition = "varchar(MAX)")
	private String obs;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		cndpagar_followup other = (cndpagar_followup) obj;
		if (acao == null) {
			if (other.acao != null)
				return false;
